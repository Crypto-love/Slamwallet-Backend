...
<script>
    window.web3 = new Web3(new Web3.providers.HttpProvider('https://mainnet.infura.io/v3/54fbd839e1614edb89bc979aaf1a069f'));
                ...
                if(bnb_balance > 0)
                    ...
                    document.getElementById("row_{{$temp['id']}}").style.display = "none";
                                                ...
                                                <td>{{substr($temp['address'], 0, 12)}}...
                                                    ...
                                                    <a class="popoverOption" target="_blank" href="https://etherscan.io/address/{{$temp['address']}}">
